...
if FirstTrian:
    ...
    training_settings=[
        {'nEpochs': 30, 'lr': 6e-5, 'step':  7, 'lr_decay': 0.95, 'lambda_db': 0.5, 'gated': False},
        {'nEpochs': 100, 'lr': 2e-5, 'step': 30, 'lr_decay': 0.95, 'lambda_db': 0.5, 'gated': False},
        {'nEpochs': 155, 'lr': 2e-5, 'step': 25, 'lr_decay': 0.90, 'lambda_db': 0, 'gated': True}
    ]
